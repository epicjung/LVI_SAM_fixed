...
public:
    ...
    void imuHandler(const sensor_msgs::Imu::ConstPtr& imuMsg)
    {
        ...
        // printf("\033[1;35mIMU in LIO\033[0m\n");
        // printf("imu %f %f %f; %f %f %f\n", imuPose.translation().x(), imuPose.translation().y(), imuPose.translation().z(), imuPose.rotation().roll(), imuPose.rotation().pitch(), imuPose.rotation().yaw());
        // printf("lidar %f %f %f; %f %f %f\n", lidarPose.translation().x(), lidarPose.translation().y(), lidarPose.translation().z(), lidarPose.rotation().roll(), lidarPose.rotation().pitch(), lidarPose.rotation().yaw());
